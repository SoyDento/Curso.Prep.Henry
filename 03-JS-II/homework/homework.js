...
if (Number.isInteger(divCinco) && Number.isInteger(divTres)) {return "fizzbuzz"}
else if (Number.isInteger(divTres) === true) {return "fizz"}
else if (Number.isInteger(divCinco) === true) {return "buzz"}
else {return numero}
}
...
else if (num3 > num1 && num3 > num2) {let num4 = num3 + 1; return num4 }
...
function tieneTresDigitos(numero){
  ...
  if (numero2.length == 3) {return true}
    else {return false}
}
